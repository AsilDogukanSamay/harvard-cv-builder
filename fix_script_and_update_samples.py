...
# Ensure validateAndRepairCVState force-refills whenever experiences length < 6
force_refill_logic = '''function validateAndRepairCVState() {
...
js_code = re.sub(r"function validateAndRepairCVState\(\) \{.*?\n\}", force_refill_logic, js_code, flags=re.DOTALL)
